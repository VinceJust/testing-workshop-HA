...
Bestehen (Standard: 60)
* @param {boolean} options.strictMode - Ob strenge Validierung
angewendet werden soll (Standard: false)
* @param {string[]} options.bonusCategories - Kategorien, die
Bonuspunkte geben (optional)
